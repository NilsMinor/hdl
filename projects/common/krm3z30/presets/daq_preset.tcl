proc getPresetInfo {} {
  return [dict create name {daq_preset} description {daq_preset}  vlnv xilinx.com:ip:processing_system7:5.5 display_name {daq_preset} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PCW_UIPARAM_DDR_DQS_3_PACKAGE_LENGTH {835}  \
    ...
    CONFIG.PCW_PACKAGE_DDR_DQS_TO_CLK_DELAY_3 {-0.365}  \
