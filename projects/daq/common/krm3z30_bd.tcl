...
ad_ip_parameter axi_ad9680_dma CONFIG.SYNC_TRANSFER_START 0                     ;# before it was 1 maybe should be 0 (see daq3)
...
ad_ip_parameter util_daq2_xcvr CONFIG.RX_LANE_INVERT 15                         ;# invert lane polarity for KRM module 15 = 4'b1111
ad_ip_parameter util_daq2_xcvr CONFIG.RX_OUT_DIV 1                              ;# [D] CPLL/QPLL output clock divider D, User guide page 55
ad_ip_parameter util_daq2_xcvr CONFIG.CPLL_FBDIV_4_5 5                          ;# [N1]
ad_ip_parameter util_daq2_xcvr CONFIG.CPLL_FBDIV 4                              ;# [N2]#
ad_ip_parameter util_daq2_xcvr CONFIG.QPLL_REFCLK_DIV 2                         ;# [M]          
ad_ip_parameter util_daq2_xcvr CONFIG.RX_CLK25_DIV  10                          ;# internal 25 MHz (250MHz/10) clock for the RX datapath

ad_ip_parameter util_daq2_xcvr CONFIG.RX_DFE_LPM_CFG 0x0904
